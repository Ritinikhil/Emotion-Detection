...
from fercnn_enhanced import SimpleFERCNN_Enhanced
...
output_dir = r"C:\Users\sys\PycharmProjects\Major_Project\experiments_cbam"
...
def train_and_eval(name, train_loader, test_loader, num_epochs=30):
    model = SimpleFERCNN_Enhanced(num_classes=7).to(device)
...
print("Starting RAF-DB training with SimpleFERCNN_Enhanced (with CBAM)...")
print("=" * 60)

raf_best = train_and_eval("RAF_CBAM", raf_train_loader, raf_test_loader, num_epochs=30)

print("\n" + "=" * 60)
print("TRAINING COMPLETE!")
print("=" * 60)
print(f"Best accuracy achieved: {raf_best:.4f} ({raf_best * 100:.2f}%)")
